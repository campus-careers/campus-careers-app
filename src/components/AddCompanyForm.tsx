        ...
        <Row className="mb-4">
          <Col md={6}>
            <Form.Group className="border p-3 rounded">
              ...
              />
              {errors.name && (
                <small className="text-black">{errors.name.message}</small>
              )}
            </Form.Group>
          </Col>
          ...
          <Col md={6}>
            <Form.Group className="border p-3 rounded">
              ...
              {errors.location && (
                <small className="text-black">{errors.location.message}</small>
              )}
            </Form.Group>
          </Col>
        </Row>
        ...
        <Row className="mb-4">
          <Col md={6}>
            <Form.Group className="border p-3 rounded">
              ...
              />
              {errors.salary && (
                <small className="text-black">{errors.salary.message}</small>
              )}
            </Form.Group>
          </Col>
        ...
        <Row className="mb-4">
          <Col>
            <Form.Group className="border p-3 rounded">
              ...
              {errors.overview && (
                <small className="text-black">{errors.overview.message}</small>
              )}
            </Form.Group>
          </Col>
        </Row>
        ...
        <Row className="mb-4">
          <Col>
            <Form.Group className="border p-3 rounded">
              ...
              />
              {errors.jobs && (
                <small className="text-black">{errors.jobs.message}</small>
              )}
            </Form.Group>
          </Col>
        </Row>
          ...
          <Col>
            <Form.Group className="border p-3 rounded">
              ...
              <Form.Control
                {...register('contacts')}
                type="text"
                placeholder="e.g. hr@company.com, (123) 456-7890"
              />
              {errors.contacts && (
                <small className="text-black">{errors.contacts.message}</small>
              )}
            </Form.Group>
          </Col>
        </Row>
